...
function Producto({ producto, addToCart, authenticated }) {
  ...
  return (
    <Card className="card-personalizada m-3">
      <Card.Img variant="top" src={producto.imagen} className="card-personalizada-img" />
      <Card.Body>
        ...
        <Button variant="primary" className="mt-2" onClick={() =>{authenticated ? addToCart(producto) : handleAddToCart()} }>Agregar al carrito</Button>
      </Card.Body>
    </Card>
  );
}
